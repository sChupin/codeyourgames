System.config({
  ...
  map: {
    ...
    "npm:typedoc@0.7.1": {
      "@types/fs-extra": "npm:@types/fs-extra@3.0.3",
      "@types/handlebars": "npm:@types/handlebars@4.0.33",
      "@types/highlight.js": "npm:@types/highlight.js@9.1.9",
      "@types/lodash": "npm:@types/lodash@4.14.68",
      "@types/marked": "npm:@types/marked@0.0.28",
      "@types/minimatch": "npm:@types/minimatch@2.0.29",
      "@types/shelljs": "npm:@types/shelljs@0.7.2",
      "fs": "github:jspm/nodelibs-fs@0.1.2",
  ...
  depCache: {
    ...
    "components/difficulty-picker.js": [
      "aurelia-framework",
      "aurelia-event-aggregator"
    ],
    "components/game-container.js": [
      "aurelia-event-aggregator",
      "aurelia-framework",
      "../services/messages",
      "../api/sensors",
    ...
    "pages/playground/board-initializer/board-initializer.js": [
      "aurelia-framework",
      "aurelia-event-aggregator",
      "aurelia-dialog",
      "../../../services/board-canvas",
      "../../../utils/custom-elements/image-gallery",
      "../../../services/messages"
    ],
    "pages/playground/board-initializer/costume-picker.js": [
      "aurelia-framework",
      "aurelia-dialog",
      "./selector"
    ],
    "pages/playground/board-initializer/selector.js": [
      "aurelia-framework",
      "aurelia-dialog"
    ],
    "pages/playground/board-initializer/sprite-list.js": [
      "aurelia-framework",
      "aurelia-event-aggregator",
      "aurelia-dialog",
      ...
      "../../../utils/custom-elements/image-gallery",
      "../../../services/board-canvas",
      "../../../utils/custom-elements/info-dialog",
      "../../../../assets/doc/sprite.json!json"
    ],
    "pages/playground/code-editor/code-editor.js": [
      "aurelia-event-aggregator",
      "aurelia-framework",
      "../../../services/messages",
      "../../../services/board-info-parser"
    ],
    "pages/playground/code-editor/editor.js": [
      "aurelia-framework",
      "aurelia-event-aggregator",
      "aurelia-i18n",
      "../../../services/messages",
      "../../../services/board-info-parser",
      "../../../services/transpiler-service",
      "../../../services/code-translator",
      "ace",
      "ace/theme-monokai",
      "ace/mode-typescript",
      "ace/ext-language_tools"
    ],
    "pages/playground/difficulty.js": [
      "aurelia-framework",
      "aurelia-router"
    ],
    ...
    "services/transpiler-service.js": [
      "aurelia-framework",
      "aurelia-event-aggregator",
      "./backend-service"
    ],
    "utils/custom-elements/collapse-panel.js": [
      "aurelia-framework"
    ],
    "utils/custom-elements/image-gallery.js": [
      "aurelia-dialog",
      "aurelia-framework",
      "../../services/backend-service"
    ],
    "utils/custom-elements/info-dialog.js": [
      "aurelia-framework",
      "aurelia-dialog"
    ],
    "utils/custom-elements/popover.js": [
      "aurelia-framework"
    ],
    "utils/custom-elements/split-view.js": [
      "aurelia-framework",
      "split.js"
    ]
  },
  bundles: {
    "app-build.js": [
      ...
      "app.js",
      "components/difficulty-picker.html!github:systemjs/plugin-text@0.0.8.js",
      "components/difficulty-picker.js",
      "components/game-container.html!github:systemjs/plugin-text@0.0.8.js",
      "components/game-container.js",
      "components/language-switcher.html!github:systemjs/plugin-text@0.0.8.js",
      "components/language-switcher.js",
      "components/nav-bar.html!github:systemjs/plugin-text@0.0.8.js",
      "main.js",
      "pages/about/index.html!github:systemjs/plugin-text@0.0.8.js",
      "pages/about/index.js",
      "pages/documentation/globals.html!github:systemjs/plugin-text@0.0.8.js",
      "pages/documentation/globals.js",
      "pages/documentation/index.html!github:systemjs/plugin-text@0.0.8.js",
      "pages/documentation/index.js",
      "pages/documentation/language.html!github:systemjs/plugin-text@0.0.8.js",
      "pages/documentation/language.js",
      "pages/documentation/types.html!github:systemjs/plugin-text@0.0.8.js",
      "pages/documentation/types.js",
      "pages/landing/index.html!github:systemjs/plugin-text@0.0.8.js",
      "pages/landing/index.js",
      "pages/playground/board-initializer/board-initializer.html!github:systemjs/plugin-text@0.0.8.js",
      "pages/playground/board-initializer/board-initializer.js",
      "pages/playground/board-initializer/costume-picker.html!github:systemjs/plugin-text@0.0.8.js",
      "pages/playground/board-initializer/costume-picker.js",
      "pages/playground/board-initializer/selector.html!github:systemjs/plugin-text@0.0.8.js",
      "pages/playground/board-initializer/selector.js",
      "pages/playground/board-initializer/sprite-list.html!github:systemjs/plugin-text@0.0.8.js",
      "pages/playground/board-initializer/sprite-list.js",
      "pages/playground/code-editor/code-editor.html!github:systemjs/plugin-text@0.0.8.js",
      "pages/playground/code-editor/code-editor.js",
      "pages/playground/code-editor/editor.html!github:systemjs/plugin-text@0.0.8.js",
      "pages/playground/code-editor/editor.js",
      "pages/playground/difficulty.html!github:systemjs/plugin-text@0.0.8.js",
      "pages/playground/difficulty.js",
      "pages/playground/index.html!github:systemjs/plugin-text@0.0.8.js",
      "pages/playground/index.js",
      "services/backend-service.js",
      "services/board-canvas.js",
      "services/board-info-parser.js",
      "services/code-translator.js",
      "services/messages.js",
      "services/transpiler-service.js",
      "utils/custom-elements/collapse-panel.html!github:systemjs/plugin-text@0.0.8.js",
      "utils/custom-elements/collapse-panel.js",
      "utils/custom-elements/doc-popover.html!github:systemjs/plugin-text@0.0.8.js",
      "utils/custom-elements/image-gallery.html!github:systemjs/plugin-text@0.0.8.js",
      "utils/custom-elements/image-gallery.js",
      "utils/custom-elements/info-dialog.html!github:systemjs/plugin-text@0.0.8.js",
      "utils/custom-elements/info-dialog.js",
      "utils/custom-elements/popover.html!github:systemjs/plugin-text@0.0.8.js",
      "utils/custom-elements/popover.js",
      "utils/custom-elements/split-view.html!github:systemjs/plugin-text@0.0.8.js",
      "utils/custom-elements/split-view.js",
      "utils/interfaces.js",
      "utils/value-converters/blob-to-url.js",
      "utils/value-converters/file-list-to-array.js",
      "utils/value-converters/round-number.js",
      "utils/value-converters/string-to-number.js",
      "utils/value-converters/to-json.js"
    ],
    "aurelia.js": [
