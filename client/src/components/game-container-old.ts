...
// import {CodeUpdate, GameDimensions} from "../services/messages";
// import {Keyboard, Mouse} from "../lib/sensors";
// import {Group} from "../lib/sprite";
...
//     this.codeUpdateSubscriber = this.ea.subscribe(CodeUpdate, msg => this.update(msg.preloadCode, msg.createCode, msg.updateCode));
...
//     this.gameProps = new GameProps(this.game, this.bodies, this.platforms, this.groups);
//   }
