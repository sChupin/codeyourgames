...
declare class fr_Decor extends Sprite {

}

declare class Platforme extends Sprite {

}

declare class Lutin extends _Image {
  // Default speed if not specified when sliding
  public vitesse: number | Velocity;
  ...
  // Translation
  public avancer(duration: number, velocity?: number | Velocity);
  public reculer(duration: number, velocity?: number | Velocity);
